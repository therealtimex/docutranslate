...
MESSAGES = {
    "en": {
        ...
        "missing_optional_dependency": "Missing optional dependency: {missing}. To start GUI, install: pip install \"docutranslate[webui]\"",
    ...
    "zh": {
        ...
        "missing_optional_dependency": "缺少可选依赖: {missing}. 如需启动图形界面，请安装: pip install \"docutranslate[webui]\"",
...
def t(key: str, *, lang: str | None = None, **kwargs) -> str:
    l = (lang or os.getenv("DOCUTRANSLATE_LANG") or "en").lower()
